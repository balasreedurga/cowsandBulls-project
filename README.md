...
- __User's name__: Let's get the player's name, if they want to share. You can then use the name 1in the congratulations and  failure messages and hints. If no name is provided, you can use a default like `Player` or `Stranger`. 
